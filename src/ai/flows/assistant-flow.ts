...
export const chatFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    console.log('Last user message (prompt):', lastUserMessage.content[0].text);
    ...
    // Fallback au cas où le modèle appellerait un outil mais ne renverrait pas de texte
    if (!textResponse) {
      console.warn('Text response is empty. This might happen if a tool was called without a final text output from the model.');
