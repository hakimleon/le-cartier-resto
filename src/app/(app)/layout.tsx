            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
               ...
               <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={pathname.startsWith('/preparations-base')}
              ...
              <SidebarMenuItem>
               ...
               <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={pathname.startsWith('/preparations/workshop')}
                  tooltip="Atelier Préparations"
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={pathname.startsWith('/atelier')}
                  tooltip="Nouvel Atelier"
                >
                  <Link href="/atelier">
                    <FlaskConical />
